...
if(!defined('TABLE_IM_CHAT'))          define('TABLE_IM_CHAT',          '`im_chat`');
if(!defined('TABLE_IM_MESSAGE'))       define('TABLE_IM_MESSAGE',       '`im_message`');
if(!defined('TABLE_IM_CHATUSER'))      define('TABLE_IM_CHATUSER',      '`im_chatuser`');
if(!defined('TABLE_IM_MESSAGESTATUS')) define('TABLE_IM_MESSAGESTATUS', '`im_messagestatus`');
if(!defined('TABLE_IM_XXCVERSION'))    define('TABLE_IM_XXCVERSION',    '`im_xxcversion`');
