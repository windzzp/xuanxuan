<?php
/**
 * The html template file of step2 method of install module of XXB.
 *
      ...
      <form method='post' action='<?php echo $this->createLink('install', 'step3');?>' class='form-inline' id='form1'>
        <table class='table table-bordered table-form'>
          ...
          <tr>
            ...
            <td><?php echo html::input('dbPrefix', 'xxb_', "class='text-3 form-control'") . html::checkBox('clearDB', $lang->install->clearDB);?></td>
          </tr>
