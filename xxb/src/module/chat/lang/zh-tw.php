...
$lang->chat->log         = '日誌';
$lang->chat->id          = 'ID';
$lang->chat->checkUpdate = '檢查更新';
$lang->chat->xxcVersion  = 'XXC版本';
$lang->chat->xxdVersion  = 'XXD版本';
$lang->chat->xxbVersion  = 'XXB版本';
$lang->chat->xxcDesc     = '升級描述';
$lang->chat->xxcReadme   = '更新日誌';
$lang->chat->strategy    = '升級策略';
$lang->chat->download    = '下載地址';
$lang->chat->notVersion  = '%s格式不正確，例如：2.5 或者 2.5.0';
$lang->chat->notempty    = '不能為空.';

$lang->chat->strategies['force']    = '強制';
$lang->chat->strategies['optional'] = '可選';
