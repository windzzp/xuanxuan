      ...
      <table class='table table-form w-p70'>
        <tr>
          ...
          <td colspan='2'>
            ...
            <?php echo html::input('xxcVersion', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang->xxbversion->xxcDesc;?></th>
          <td colspan='2'>
            <?php echo html::textarea('xxcDesc', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          ...
          <td colspan='2'>
            <table class='table table-borderless'>
              ...
              <tr>
                ...
                <td><?php echo html::input("xxcDownload[{$system}]", '', "class='form-control'");?></td>
              </tr>
              <?php endforeach;?>
            </table>
          </td>
        ...
        <tr>
          ...
          <td colspan='2'>
            <div class='required required-wrapper'></div>
              <?php echo html::input('xxdVersion', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang->xxbversion->xxdDesc;?></th>
          <td colspan='2'>
              <?php echo html::textarea('xxdDesc', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          ...
          <td colspan='2'>
            <table class='table table-borderless'>
              ...
              <tr>
                <th class="w-160px text-right"><?php echo $lang->xxbversion->system[$system]?></th>
                <td><?php echo html::input("xxdDownload[{$system}]", '', "class='form-control'");?></td>
              </tr>
              <?php endforeach;?>
            </table>
          </td>
        ...
        <tr>
          ...
          <td colspan='2'>
            <div class='required required-wrapper'></div>
              <?php echo html::input('xxbVersion', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          <th><?php echo $lang->xxbversion->xxbDesc;?></th>
          <td colspan='2'>
              <?php echo html::textarea('xxbDesc', '', "class='form-control'");?>
          </td>
        </tr>
        <tr>
          ...
          <td colspan='2'>
            <table class='table table-borderless'>
              ...
              <tr>
                <th class="w-160px text-right"><?php echo $lang->xxbversion->system[$system]?></th>
                <td><?php echo html::input("xxbDownload[{$system}]", '', "class='form-control'");?></td>
              </tr>
              <?php endforeach;?>
            </table>
          </td>
