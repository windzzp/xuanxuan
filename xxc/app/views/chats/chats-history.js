...
export default class ChatsHistory extends Component {
    ...
    renderChatsGroup(group) {
        ...
        return (
            <div key={group.name} className="app-chats-history-menu-group">
        ...
        return (
            ...
            >
                    ...
                    <nav style={{overflow: 'visible'}} className="flex-none nav hint--bottom" data-hint={Lang.string('chats.history.fetchAllFromServer')}>
                        {
                            this.state.isFetching ? (
                                ...
                                <a onClick={this.handleFetchAllBtnClick} className={HTML.classes('text-primary', {disabled: this.state.searching})}><Icon name="cloud-sync" /> &nbsp; <small>{Lang.string('chats.history.fetchAll')}</small></a>
                            )
                        }
                    </nav>
                </div>
                <div className="app-chats-history-content flex-auto row single">
                    ...
                    {
                        this.state.choosed ? (
                            <div className="row single flex-auto">
                                <ChatSearchResult
