...
export default class MessageListItem extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (isJustLangSwitched()
            ...
            || (nextProps.lastMessage && nextProps.lastMessage.deleted && this.prevLastMessageUpdatedId !== nextProps.lastMessage.updateId)
    ...
    render() {
        ...
        this.prevLastMessageUpdatedId = lastMessage && lastMessage.updateId;
        ...
        if (hideHeader === 0) {
            hideHeader = !showDateDivider && lastMessage && lastMessage.senderId === message.senderId && lastMessage.type === message.type && !lastMessage.deleted;
        }
